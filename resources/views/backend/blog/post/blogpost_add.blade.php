                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="myForm" method="post" action="{{ route('store.blog.post') }}"
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            <select name="category_id" class="form-select form-control" id="inputVendor">
                                                ...
                                                @foreach ($blogcategory as $cat)
                                                    <option value="{{ $cat->id }}" {{ old('category_id') == $cat->id ? 'selected' : '' }}>{{ $cat->blog_category_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">Blog Short Decs  <span class="text-danger">*</span></h6>
                                        </div>
                                        <div class="form-group col-sm-9 text-secondary">
                                            <textarea name="post_short_description" class="form-control" >{{ old('post_short_description') }}</textarea>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">Blog Long Decs <span class="text-danger">*</span></h6>
                                        </div>

                                        <div class="form-group col-sm-9 text-secondary">
                                            <textarea class="form-control" name="post_long_description" id="mytextarea" >{{ old('post_long_description') }}</textarea>
        ...
        $(document).ready(function() {
            $('#myForm').validate({
                ...
                messages: {
                    ...
                    post_title: {
                        required: 'Please write post title name',
                    },
                    post_short_description: {
                        required: 'Please write post Short Description',
                    },
                    post_long_description: {
                        required: 'Please write post Long Description',
                    },
                    post_image: {
